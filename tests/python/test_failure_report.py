...
# --------------------------------------------------------------------------- #
# (b) A fresh injector's ledger/counts start empty                            #
# --------------------------------------------------------------------------- #
...
def test_fresh_injector_ledger_and_counts_are_empty():
    """A freshly constructed injector reports an empty ledger and empty
    failure counts before any GenerateEvent call."""
...
def test_forced_failure_repeated_aggregates_count_not_entries():
    ...
    # Backward-compat aggregation still works off the same ledger.
    counts = inj.GetFailureCounts()
