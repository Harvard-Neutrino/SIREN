...
CEREAL_CLASS_VERSION(SI::geometry::Sphere, 0);
CEREAL_REGISTER_TYPE(SI::geometry::Sphere)
CEREAL_REGISTER_POLYMORPHIC_RELATION(SI::geometry::Geometry, SI::geometry::Sphere);
