...
BooleanGeometry::BooleanGeometry() : Geometry("BooleanGeometry"), op_(BooleanOperation::UNION), left_(nullptr), right_(nullptr) { RecomputeWorldAABB(); }
BooleanGeometry::BooleanGeometry(BooleanOperation op, std::shared_ptr<const Geometry> left, std::shared_ptr<const Geometry> right) : Geometry("BooleanGeometry"), op_(op), left_(left), right_(right) { RecomputeWorldAABB(); }
BooleanGeometry::BooleanGeometry(Placement const & p, BooleanOperation op, std::shared_ptr<const Geometry> left, std::shared_ptr<const Geometry> right) : Geometry("BooleanGeometry", p), op_(op), left_(left), right_(right) { RecomputeWorldAABB(); }
BooleanGeometry::BooleanGeometry(const BooleanGeometry& o) : Geometry(o), op_(o.op_), left_(o.left_), right_(o.right_) { RecomputeWorldAABB(); }

SIREN_GEOMETRY_SWAP(BooleanGeometry, op_, left_, right_)
SIREN_GEOMETRY_ASSIGN(BooleanGeometry)
