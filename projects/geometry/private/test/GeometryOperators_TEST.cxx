...
TEST(GeometryOps, CrossTypeOrdering) {
    Box box(10, 8, 6);
    Sphere sphere(5, 0);
    Cylinder cyl(4, 0, 10);
    ...
    // No 3-cycle (transitivity)
    EXPECT_FALSE(box_lt_sphere && sphere_lt_cyl && cyl_lt_box);
    EXPECT_FALSE(sphere_lt_box && cyl_lt_sphere && box_lt_cyl);
}

TEST(GeometryOps, SameTypeDifferentParams) {
...
TEST(GeometryOps, SameTypeEqualParams) {
    Sphere a(5, 2);
    Sphere b(5, 2);
    EXPECT_FALSE(a < b);
    EXPECT_FALSE(b < a);
