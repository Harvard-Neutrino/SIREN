...
struct InteractionSignature {
    LI::dataclasses::ParticleType primary_type = LI::dataclasses::ParticleType::unknown;
    LI::dataclasses::ParticleType target_type = LI::dataclasses::ParticleType::unknown;
