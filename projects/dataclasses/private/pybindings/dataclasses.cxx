...
PYBIND11_MODULE(dataclasses,m) {
  ...
  enum_<Particle::ParticleType>(particle, "ParticleType")
          ...
          .value("NuLight",Particle::ParticleType::NuLight)
          .value("Nu1",Particle::ParticleType::Nu1)
          .value("Nu2",Particle::ParticleType::Nu2)
          .value("Nu3",Particle::ParticleType::Nu3)
          .value("N4",Particle::ParticleType::N4)
          .value("N5",Particle::ParticleType::N5)
          .value("N6",Particle::ParticleType::N6)
          .value("ZPrime",Particle::ParticleType::ZPrime)
          .value("HPrime",Particle::ParticleType::HPrime)
          .value("PhiPrime",Particle::ParticleType::PhiPrime)
          .value("ALP",Particle::ParticleType::ALP)
