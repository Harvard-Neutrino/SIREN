...
void register_DarkNewsDecay(pybind11::module_ & m) {
    ...
    DarkNewsDecay
        ...
        .def("TotalDecayWidthAllFinalStates",overload_cast<siren::dataclasses::InteractionRecord const &>(&DarkNewsDecay::TotalDecayWidthAllFinalStates, const_))
        .def("TotalDecayWidthAllFinalStates",overload_cast<siren::dataclasses::ParticleType const &>(&DarkNewsDecay::TotalDecayWidthAllFinalStates, const_))
        .def("TotalDecayWidth",&DarkNewsDecay::TotalDecayWidth)
