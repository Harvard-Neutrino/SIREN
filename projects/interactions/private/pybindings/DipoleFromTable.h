...
void register_DipoleFromTable(pybind11::module_ & m) {
    ...
    dipolefromtable
        ...
        .def(init<double, double, DipoleFromTable::HelicityChannel, std::set<LI::dataclasses::ParticleType>>())
        .def(self == self)
        .def(init<double, double, DipoleFromTable::HelicityChannel, bool, bool, std::set<LI::dataclasses::ParticleType>>())
        .def(init<double, double, DipoleFromTable::HelicityChannel, bool, bool, bool, std::set<LI::dataclasses::ParticleType>>())
        .def("TotalCrossSection",overload_cast<LI::dataclasses::InteractionRecord const &>(&DipoleFromTable::TotalCrossSection, const_))
        .def("TotalCrossSection",overload_cast<LI::dataclasses::ParticleType, double, LI::dataclasses::ParticleType>(&DipoleFromTable::TotalCrossSection, const_))
        ...
        .def("DifferentialCrossSection",overload_cast<LI::dataclasses::ParticleType, double, LI::dataclasses::ParticleType, double, double>(&DipoleFromTable::DifferentialCrossSection, const_))
        .def("DifferentialCrossSection",overload_cast<LI::dataclasses::ParticleType, double, LI::dataclasses::ParticleType, double, double, double>(&DipoleFromTable::DifferentialCrossSection, const_))
