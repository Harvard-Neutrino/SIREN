...
void register_HNLDipoleDecay(pybind11::module_ & m) {
    ...
    HNLDipoleDecay
        ...
        .def("TotalDecayWidthAllFinalStates",overload_cast<siren::dataclasses::InteractionRecord const &>(&HNLDipoleDecay::TotalDecayWidthAllFinalStates, const_))
        .def("TotalDecayWidth",overload_cast<siren::dataclasses::ParticleType>(&HNLDipoleDecay::TotalDecayWidth, const_))
        .def("TotalDecayWidth",(double (siren::interactions::HNLDipoleDecay::*)(siren::dataclasses::InteractionRecord const &) const)&HNLDipoleDecay::TotalDecayWidth)
