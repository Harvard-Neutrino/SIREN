...
void register_HNLDecay(pybind11::module_ & m) {
    ...
    HNLDecay
        ...
        .def("TotalDecayWidthAllFinalStates",overload_cast<siren::dataclasses::InteractionRecord const &>(&HNLDecay::TotalDecayWidthAllFinalStates, const_))
        .def("TotalDecayWidth",overload_cast<siren::dataclasses::ParticleType>(&HNLDecay::TotalDecayWidth, const_))
        .def("TotalDecayWidth",(double (siren::interactions::HNLDecay::*)(siren::dataclasses::InteractionRecord const &) const)&HNLDecay::TotalDecayWidth)
