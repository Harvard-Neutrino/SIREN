...
void register_NeutrissimoDecay(pybind11::module_ & m) {
    ...
    neutrissimodecay
        ...
        .def("TotalDecayWidthAllFinalStates",overload_cast<siren::dataclasses::InteractionRecord const &>(&NeutrissimoDecay::TotalDecayWidthAllFinalStates, const_))
        .def("TotalDecayWidthAllFinalStates",overload_cast<siren::dataclasses::ParticleType const &>(&NeutrissimoDecay::TotalDecayWidthAllFinalStates, const_))
        .def("TotalDecayWidth",&NeutrissimoDecay::TotalDecayWidth)
