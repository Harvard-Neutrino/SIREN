...
CEREAL_CLASS_VERSION(LI::interactions::NeutrissimoDecay, 0);
CEREAL_REGISTER_TYPE(LI::interactions::NeutrissimoDecay);
CEREAL_REGISTER_POLYMORPHIC_RELATION(LI::interactions::Decay, LI::interactions::NeutrissimoDecay);
