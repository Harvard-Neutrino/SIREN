...
public:
    ...
    virtual double PrimaryMass() const;
...
CEREAL_CLASS_VERSION(LI::interactions::DarkNewsCrossSection, 0);
CEREAL_REGISTER_TYPE(LI::interactions::DarkNewsCrossSection);
CEREAL_REGISTER_POLYMORPHIC_RELATION(LI::interactions::CrossSection, LI::interactions::DarkNewsCrossSection);
