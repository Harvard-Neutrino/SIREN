...
CEREAL_CLASS_VERSION(LI::interactions::HNLFromSpline, 0);
CEREAL_REGISTER_TYPE(LI::interactions::HNLFromSpline);
CEREAL_REGISTER_POLYMORPHIC_RELATION(LI::interactions::CrossSection, LI::interactions::HNLFromSpline);
