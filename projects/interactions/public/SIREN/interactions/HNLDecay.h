...
public:
    ...
    HNLDecay(double hnl_mass, std::vector<double> mixing, ChiralNature nature, std::set<SI::dataclasses::ParticleType> const & primary_types) : hnl_mass(hnl_mass), mixing(mixing), nature(nature), primary_types(primary_types) {};
    ...
    HNLDecay(double hnl_mass, double mixing, ChiralNature nature, std::set<SI::dataclasses::ParticleType> const & primary_types) : hnl_mass(hnl_mass), mixing(std::vector<double>{0,0,mixing}), nature(nature), primary_types(primary_types) {};
    ...
    virtual void SampleFinalState(dataclasses::InteractionRecord &, std::shared_ptr<SI::utilities::LI_random>) const override;
...
CEREAL_CLASS_VERSION(SI::interactions::HNLDecay, 0);
CEREAL_REGISTER_TYPE(SI::interactions::HNLDecay);
CEREAL_REGISTER_POLYMORPHIC_RELATION(SI::interactions::Decay, SI::interactions::HNLDecay);
