...
public:
    ...
    HNLDecay(double hnl_mass, std::vector<double> mixing, ChiralNature nature, std::set<LI::dataclasses::Particle::ParticleType> const & primary_types) : hnl_mass(hnl_mass), mixing(mixing), nature(nature), primary_types(primary_types) {};
    ...
    HNLDecay(double hnl_mass, double mixing, ChiralNature nature, std::set<LI::dataclasses::Particle::ParticleType> const & primary_types) : hnl_mass(hnl_mass), mixing(std::vector<double>{0,0,mixing}), nature(nature), primary_types(primary_types) {};
...
CEREAL_CLASS_VERSION(LI::crosssections::HNLDecay, 0);
CEREAL_REGISTER_TYPE(LI::crosssections::HNLDecay);
CEREAL_REGISTER_POLYMORPHIC_RELATION(LI::crosssections::Decay, LI::crosssections::HNLDecay);
