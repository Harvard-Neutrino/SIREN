...
CEREAL_CLASS_VERSION(LI::crosssections::DarkNewsDecay, 0);
CEREAL_REGISTER_TYPE(LI::crosssections::DarkNewsDecay);
CEREAL_REGISTER_POLYMORPHIC_RELATION(LI::crosssections::Decay, LI::crosssections::DarkNewsDecay);
