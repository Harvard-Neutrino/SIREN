...
double CrossSectionProbability(std::shared_ptr<LI::detector::EarthModel const>, std::shared_ptr<LI::crosssections::InteractionCollection const>, LI::dataclasses::InteractionRecord const &);
