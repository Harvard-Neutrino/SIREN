...
template<typename ProcessType>
double ProcessWeighter<ProcessType>::GenerationProbability(LI::dataclasses::InteractionTreeDatum const & datum ) const {
...
template<typename ProcessType>
ProcessWeighter<ProcessType>::ProcessWeighter(std::shared_ptr<LI::injection::PhysicalProcess> phys_process, std::shared_ptr<ProcessType> inj_process, std::shared_ptr<LI::detector::DetectorModel> detector_model)
...
template<>
std::vector<std::shared_ptr<LI::distributions::PrimaryInjectionDistribution>> const & PrimaryProcessWeighter::GetInjectionDistributions() {
    return inj_process->GetPrimaryInjectionDistributions();
}

template<>
std::vector<std::shared_ptr<LI::distributions::SecondaryInjectionDistribution>> const & SecondaryProcessWeighter::GetInjectionDistributions() {
