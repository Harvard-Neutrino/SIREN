...
#include "LeptonInjector/injection/InjectorBase.h"                // for Inj...
...
double LeptonProcessWeighter::InteractionProbability(std::pair<LI::math::Vector3D, LI::math::Vector3D> const & bounds, LI::dataclasses::InteractionRecord const & record) const {
    ...
    std::map<LI::dataclasses::Particle::ParticleType, std::vector<std::shared_ptr<LI::interactions::CrossSection>>> const & cross_sections_by_target = phys_process->cross_sections->GetCrossSectionsByTarget();
