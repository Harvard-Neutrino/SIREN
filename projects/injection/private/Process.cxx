...
Process::Process(SI::dataclasses::ParticleType _primary_type, std::shared_ptr<interactions::InteractionCollection> _interactions) : primary_type(_primary_type), interactions(_interactions) {}
...
void Process::SetPrimaryType(SI::dataclasses::ParticleType _primary_type) {
    primary_type = _primary_type;
}

SI::dataclasses::ParticleType Process::GetPrimaryType() const {
    return primary_type;
}
...
PhysicalProcess::PhysicalProcess(SI::dataclasses::ParticleType _primary_type, std::shared_ptr<interactions::InteractionCollection> _interactions) : Process(_primary_type, _interactions) {};
...
PrimaryInjectionProcess::PrimaryInjectionProcess(SI::dataclasses::ParticleType _primary_type, std::shared_ptr<interactions::InteractionCollection> _interactions) : PhysicalProcess(_primary_type, _interactions) {};
...
SecondaryInjectionProcess::SecondaryInjectionProcess(SI::dataclasses::ParticleType _primary_type, std::shared_ptr<interactions::InteractionCollection> _interactions) : PhysicalProcess(_primary_type, _interactions) {};
