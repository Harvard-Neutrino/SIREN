...
void TargetMomentumDistribution::Sample(
    ...
    record.target_momentum = SampleMomentum(rand, detector_model, interactions, record);
}
...
double TargetAtRest::GenerationProbability(std::shared_ptr<LI::detector::DetectorModel const> detector_model, std::shared_ptr<LI::interactions::InteractionCollection const> interactions, LI::dataclasses::InteractionRecord const & record) const {
    return 1.0;
}
