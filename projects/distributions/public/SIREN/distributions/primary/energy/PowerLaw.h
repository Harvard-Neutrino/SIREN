...
CEREAL_CLASS_VERSION(SI::distributions::PowerLaw, 0);
CEREAL_REGISTER_TYPE(SI::distributions::PowerLaw);
CEREAL_REGISTER_POLYMORPHIC_RELATION(SI::distributions::PrimaryEnergyDistribution, SI::distributions::PowerLaw);
