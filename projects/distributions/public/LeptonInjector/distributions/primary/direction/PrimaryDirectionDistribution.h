...
private:
    virtual LI::math::Vector3D SampleDirection(std::shared_ptr<LI::utilities::LI_random> rand, std::shared_ptr<LI::detector::DetectorModel const> detector_model, std::shared_ptr<LI::interactions::InteractionCollection const> interactions, LI::dataclasses::PrimaryDistributionRecord & record) const = 0;
public:
...
CEREAL_REGISTER_POLYMORPHIC_RELATION(LI::distributions::PrimaryInjectionDistribution, LI::distributions::PrimaryDirectionDistribution);
