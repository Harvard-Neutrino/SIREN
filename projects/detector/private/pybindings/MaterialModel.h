...
void register_MaterialModel(pybind11::module_ & m) {
    ...
    material_model
        ...
        .def("GetTargetMassFraction", (double (MaterialModel::*)(int, LI::dataclasses::Particle::ParticleType) const)(&MaterialModel::GetTargetMassFraction))
        .def("GetTargetMassFraction", (std::vector<double> (MaterialModel::*)(int, std::vector<LI::dataclasses::Particle::ParticleType> const &) const)(&MaterialModel::GetTargetMassFraction))
        .def("GetTargetParticleFraction", (double (MaterialModel::*)(int, LI::dataclasses::Particle::ParticleType) const)(&MaterialModel::GetTargetParticleFraction))
        .def("GetTargetParticleFraction", (std::vector<double> (MaterialModel::*)(int, std::vector<LI::dataclasses::Particle::ParticleType> const &) const)(&MaterialModel::GetTargetParticleFraction))
        .def("GetTargetRadiationFraction", (std::vector<double> (MaterialModel::*)(int, std::vector<LI::dataclasses::Particle::ParticleType> const &) const)(&MaterialModel::GetTargetRadiationFraction))
    ...
    class_<MaterialModel::Component>(material_model, "Component")
        .def(init<>())
        .def(init<LI::dataclasses::Particle::ParticleType>())
        .def(self == self)
