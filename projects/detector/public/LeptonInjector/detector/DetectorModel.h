...
private:
    ...
    double GetParticleDensity(geometry::Geometry::IntersectionList const & intersections, GeometryPosition const & p0, LI::dataclasses::ParticleType target) const;
    double GetParticleDensity(GeometryPosition const & p0, LI::dataclasses::ParticleType target) const;
    ...
    double GetMassDensity(geometry::Geometry::IntersectionList const & intersections, GeometryPosition const & p0, std::set<LI::dataclasses::ParticleType> targets) const;
    double GetMassDensity(GeometryPosition const & p0, std::set<LI::dataclasses::ParticleType> targets) const;
    ...
    std::vector<double> GetParticleDensity(geometry::Geometry::IntersectionList const & intersections, GeometryPosition const & p0, std::set<LI::dataclasses::ParticleType> targets) const;
    std::vector<double> GetParticleDensity(GeometryPosition const & p0, std::set<LI::dataclasses::ParticleType> targets) const;
    template<typename Iterator, typename = typename std::enable_if<std::is_same<LI::dataclasses::ParticleType, typename Iterator::value_type>::value, Iterator>::type>
    ...
    std::vector<double> GetParticleColumnDepth(geometry::Geometry::IntersectionList const & intersections, GeometryPosition const & p0, GeometryPosition const & p1, std::vector<LI::dataclasses::ParticleType> const & targets) const;
    ...
    std::set<LI::dataclasses::ParticleType> GetAvailableTargets(GeometryPosition const & vertex) const;
    std::set<LI::dataclasses::ParticleType> GetAvailableTargets(geometry::Geometry::IntersectionList const & intersections, GeometryPosition const & vertex) const;
...
public:
    ...
    double GetParticleDensity(geometry::Geometry::IntersectionList const & intersections, DetectorPosition const & p0, LI::dataclasses::ParticleType target) const;
    double GetParticleDensity(DetectorPosition const & p0, LI::dataclasses::ParticleType target) const;
    ...
    // Density/CD calculations with general target list, not just nucleon/electron
    double GetMassDensity(geometry::Geometry::IntersectionList const & intersections, DetectorPosition const & p0, std::set<LI::dataclasses::ParticleType> targets) const;
    double GetMassDensity(DetectorPosition const & p0, std::set<LI::dataclasses::ParticleType> targets) const;
    template<typename Iterator, typename = typename std::enable_if<std::is_same<LI::dataclasses::ParticleType, typename Iterator::value_type>::value, Iterator>::type>
    ...
    std::vector<double> GetParticleDensity(geometry::Geometry::IntersectionList const & intersections, DetectorPosition const & p0, std::set<LI::dataclasses::ParticleType> targets) const;
    std::vector<double> GetParticleDensity(DetectorPosition const & p0, std::set<LI::dataclasses::ParticleType> targets) const;
    template<typename Iterator, typename = typename std::enable_if<std::is_same<LI::dataclasses::ParticleType, typename Iterator::value_type>::value, Iterator>::type>
    ...
    std::vector<double> GetParticleColumnDepth(geometry::Geometry::IntersectionList const & intersections, DetectorPosition const & p0, DetectorPosition const & p1, std::vector<LI::dataclasses::ParticleType> const & targets) const;
    ...
    std::set<LI::dataclasses::ParticleType> GetAvailableTargets(DetectorPosition const & vertex) const;
    std::set<LI::dataclasses::ParticleType> GetAvailableTargets(geometry::Geometry::IntersectionList const & intersections, DetectorPosition const & vertex) const;
...
public:
    ...
    double GetTargetMass(LI::dataclasses::ParticleType target) const;
};
