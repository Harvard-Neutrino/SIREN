...
// typedef DensityDistribution1D<LI::detector::RadialAxis1D ConstantDensityDistribution;

} // namespace detector
} // namespace LI

CEREAL_CLASS_VERSION(LI::detector::ConstantDensityDistribution, 0);
CEREAL_REGISTER_TYPE(LI::detector::ConstantDensityDistribution);
CEREAL_REGISTER_POLYMORPHIC_RELATION(LI::detector::DensityDistribution, LI::detector::ConstantDensityDistribution);
