...
namespace SI { namespace detector { class Path; } }
namespace SI { namespace detector { class DensityDistribution; } }
...
private:
    ...
    double GetParticleDensity(geometry::Geometry::IntersectionList const & intersections, GeometryPosition const & p0, SI::dataclasses::ParticleType target) const;
    double GetParticleDensity(GeometryPosition const & p0, SI::dataclasses::ParticleType target) const;
    ...
    double GetMassDensity(geometry::Geometry::IntersectionList const & intersections, GeometryPosition const & p0, std::set<SI::dataclasses::ParticleType> targets) const;
    double GetMassDensity(GeometryPosition const & p0, std::set<SI::dataclasses::ParticleType> targets) const;
    ...
    std::vector<double> GetParticleDensity(geometry::Geometry::IntersectionList const & intersections, GeometryPosition const & p0, std::set<SI::dataclasses::ParticleType> targets) const;
    std::vector<double> GetParticleDensity(GeometryPosition const & p0, std::set<SI::dataclasses::ParticleType> targets) const;
    template<typename Iterator, typename = typename std::enable_if<std::is_same<SI::dataclasses::ParticleType, typename Iterator::value_type>::value, Iterator>::type>
    ...
    std::vector<double> GetParticleColumnDepth(geometry::Geometry::IntersectionList const & intersections, GeometryPosition const & p0, GeometryPosition const & p1, std::vector<SI::dataclasses::ParticleType> const & targets) const;
    ...
    std::set<SI::dataclasses::ParticleType> GetAvailableTargets(GeometryPosition const & vertex) const;
    std::set<SI::dataclasses::ParticleType> GetAvailableTargets(geometry::Geometry::IntersectionList const & intersections, GeometryPosition const & vertex) const;
...
public:
    ...
    double GetParticleDensity(geometry::Geometry::IntersectionList const & intersections, DetectorPosition const & p0, SI::dataclasses::ParticleType target) const;
    double GetParticleDensity(DetectorPosition const & p0, SI::dataclasses::ParticleType target) const;
    ...
    // Density/CD calculations with general target list, not just nucleon/electron
    double GetMassDensity(geometry::Geometry::IntersectionList const & intersections, DetectorPosition const & p0, std::set<SI::dataclasses::ParticleType> targets) const;
    double GetMassDensity(DetectorPosition const & p0, std::set<SI::dataclasses::ParticleType> targets) const;
    template<typename Iterator, typename = typename std::enable_if<std::is_same<SI::dataclasses::ParticleType, typename Iterator::value_type>::value, Iterator>::type>
    ...
    std::vector<double> GetParticleDensity(geometry::Geometry::IntersectionList const & intersections, DetectorPosition const & p0, std::set<SI::dataclasses::ParticleType> targets) const;
    std::vector<double> GetParticleDensity(DetectorPosition const & p0, std::set<SI::dataclasses::ParticleType> targets) const;
    template<typename Iterator, typename = typename std::enable_if<std::is_same<SI::dataclasses::ParticleType, typename Iterator::value_type>::value, Iterator>::type>
    ...
    std::vector<double> GetParticleColumnDepth(geometry::Geometry::IntersectionList const & intersections, DetectorPosition const & p0, DetectorPosition const & p1, std::vector<SI::dataclasses::ParticleType> const & targets) const;
    ...
    std::set<SI::dataclasses::ParticleType> GetAvailableTargets(DetectorPosition const & vertex) const;
    std::set<SI::dataclasses::ParticleType> GetAvailableTargets(geometry::Geometry::IntersectionList const & intersections, DetectorPosition const & vertex) const;
    ...
    static std::tuple<SI::math::Vector3D, SI::math::Quaternion> ParseDetector(std::stringstream & ss);
    ...
    static std::shared_ptr<geometry::Geometry> ParseFiducialVolume(std::string line, SI::math::Vector3D detector_origin, SI::math::Quaternion detector_quaternion);
...
public:
    ...
    double GetTargetMass(SI::dataclasses::ParticleType target) const;
};
...
std::ostream& operator<<(std::ostream& oss, SI::detector::DetectorSector const & bcm);
std::ostream& operator<<(std::ostream& oss, SI::detector::DetectorSector & bcm);

#include "SIREN/detector/DetectorModel.tcc"

CEREAL_CLASS_VERSION(SI::detector::DetectorModel, 0);
