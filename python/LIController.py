...
class LIController:
    ...
    def SetCrossSections(self,
        ...
        self.primary_injection_process.SetCrossSections(primary_interaction_collection)
        self.primary_physical_process.SetCrossSections(primary_interaction_collection)
