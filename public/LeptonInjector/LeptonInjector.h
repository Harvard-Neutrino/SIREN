...
public:
    ...
    virtual void SampleSecondaryDecay(InteractionRecord const & interaction, DecayRecord & decay, double width, double alpha_gen, double alpha_phys, earthmodel::Geometry *fiducial, double buffer) const;
