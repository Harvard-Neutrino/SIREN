...
_MB_WORLD_FULL = _MB_BERM_FULL_W + 20.0  # world full width (x/z) with margin
_MB_WORLD_FULL_Y = max(abs(_MB_Y_BERM_SPHERE_TOP), abs(_MB_Y_BERM_SPHERE_BOT)) * 2.0 + 20.0     # world full height (y) with margin
...
def build_composite(
    ...
    # GDML <box> x/y/z are FULL widths (GDMLSolidParser ParseBox); these are
    # the full site-volume dimensions, and the slab heights below are full
    # heights derived from top/bottom coordinates.
    box_x = 1800.0
    box_y = 400.0
    box_z = 2600.0
