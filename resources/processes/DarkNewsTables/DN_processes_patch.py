...
if not (hasattr(processes, "_siren_patch") and processes._siren_path):
    processes.UpScatteringProcess = UpscatteringProcess
    processes.FermionDileptonDecay = FermionDileptonDecay
    processes.FermionSinglePhotonDecay = FermionSinglePhotonDecay
