...
and the Recursive2Body density) comes from siren.three_body; this
module supplies the matrix elements, the lab-frame V1
...
from siren.three_body import (
    dalitz_band as _dalitz_band,
    dalitz_width as _dalitz_width,
    find_max_weight as _find_max_weight,
    sample_energies as _sample_energies,
    build_rest_momenta as _build_rest_momenta,
    boost_four_vector as _boost_four_vector,
    final_state_probability as _final_state_probability,
)
